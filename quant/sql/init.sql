...
--
-- Schema revision: 0028_factor_correlation
...
CREATE TABLE `quant_factor_def` (
  ...
  `parent_factor_key` VARCHAR(64) DEFAULT NULL,
  ...
  KEY `ix_quant_factor_def_owner_id` (`owner_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `quant_factor_correlation` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `user_id` VARCHAR(36) NOT NULL,
  `factor_key` VARCHAR(64) DEFAULT NULL,
  `expression` JSON DEFAULT NULL,
  `expression_hash` VARCHAR(64) DEFAULT NULL,
  `benchmark_keys` JSON NOT NULL,
  `start` DATE NOT NULL,
  `end` DATE NOT NULL,
  `pool_id` INT DEFAULT NULL,
  `codes` JSON DEFAULT NULL,
  ...
  `finished_at` DATETIME DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `ix_quant_factor_correlation_user_id` (`user_id`),
  KEY `ix_quant_factor_correlation_factor_key` (`factor_key`),
  KEY `ix_quant_factor_correlation_status` (`status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `quant_factor_def`
  (`key`, `name`, `description`, `category`, `unit`, `direction`, `limits`,
   ...
   `enabled`, `is_system`, `owner_id`, `parent_factor_key`,
...
VALUES
  ('mom20', '近20日涨跌幅', '当前收盘价相对20个交易日前的变化幅度。',
   ...
   21, 1, 1, '00000000-0000-0000-0000-000000000000', NULL,
  ...
  ('mom60', '近60日涨跌幅', '当前收盘价相对60个交易日前的变化幅度。',
   ...
   61, 1, 1, '00000000-0000-0000-0000-000000000000', NULL,
   CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('rsi14', '近期强弱程度（RSI 14）', '比较近14日上涨和下跌力度，取值通常为0至100。',
   ...
   15, 1, 1, '00000000-0000-0000-0000-000000000000', NULL,
   CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ...
  ('vol_ratio5', '成交量相对5日平均', '当日成交量相对过去5日平均成交量的倍数。',
   ...
   6, 1, 1, '00000000-0000-0000-0000-000000000000', NULL,
   CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('ma20_slope', '20日平均价格趋势', '20日均线相对5个交易日前的变化幅度。',
   ...
   25, 1, 1, '00000000-0000-0000-0000-000000000000', NULL,
   CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('amount_avg20', '近20日日均成交额', '近20个交易日成交额的平均值。',
   ...
   20, 1, 1, '00000000-0000-0000-0000-000000000000', NULL,
   CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
VALUES ('0028_factor_correlation');
