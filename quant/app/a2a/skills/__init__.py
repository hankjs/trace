...
SKILLS: dict[str, SkillHandler] = {
    ...
    "factor.backfill": factor_backfill.handle,
    "factor.correlation": factor_correlation.handle,
    "factor.correlation_get": factor_correlation_get.handle,
